...
- [Managing workflows](guide/managing-workflows.md) — declarative DAG workflows, the phase schema, editing, and the interactive DAG view: `daedalus workflow list`, `create`, `show`, `add-phase`, `edit-phase`, `remove-phase`, and `remove`.
