...
- [Validating conventions](guide/validating-conventions.md) — check a shared `.daedalus/` workspace against the team conventions (kebab-case and id patterns, the workspace layout, canonical YAML/Markdown formatting, and traceability links), read the violation report, and gate on its exit codes: `daedalus validate`.
